...
flags.DEFINE_boolean("stem", True, "Stem words - current is porter.")
flags.DEFINE_integer("first_n", 20000, "Clean raw - use first_n number of words (smaller dataset).")
...
if __name__ == "__main__":
    ...
    makedirs(model_dir)
    txt8_data_clean = load_data(FLAGS.clean,model_dir,FLAGS.first_n,FLAGS.stem)
